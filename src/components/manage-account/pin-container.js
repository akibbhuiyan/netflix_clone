...
const PinContainer = ({
  ...
  return (
    showPinContainer && (
      <div className="z-[100] bg-[#141414] flex-col min-h-screen flex justify-center items-center absolute top-0 left-0 right-0">
        <div className="">
          <span
        ...
        <h1 className="text-gray-400 font-bold text-[16px] mb-4">
          Profile Lock is currently Enabled
        </h1>
        {pinError ? (
          <h2 className="text-[#e6b209] font-bold text-[30px]">
            Ooops ,Wrong Pin Please try again
          </h2>
        ) : (
