...
export const UnAuthBanner = ({ router }) => {
  return (
...
const UnAuthPage = () => {
  const [showCurrentAnswer, setShowCurrentAnswer] = useState(null);
      ...
      <main>
        <div className="bg-[#000000]">
          ...
          <div className="border-b-8 border-gray-800 pb-8">
            <div className="flex flex-col h-[85vh] lg:h-[95vh] text-white px-8 sm:px-28 md:px-48 xl:px-80 mt-3 sm:mt-14">
              <h1 className="text-xl sm:text-3xl md:text-4xl lg:text-5xl text-bold text-center px-14 md:px-0 mb-5">
              ...
              {questions.map((ques, idx) => (
                <div className="flex flex-col gap-3">
                  ...
                  >
                    <h2 className="">{ques.ques}</h2>
                    <PlusIcon color="white" className="h-7 w-7" />
                  </div>
                  {showCurrentAnswer === idx && (
